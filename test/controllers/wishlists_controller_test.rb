...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { wish_date: @wishlist.wish_date, wishstatus: @wishlist.wishstatus } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { wish_date: @wishlist.wish_date, wishstatus: @wishlist.wishstatus } }
